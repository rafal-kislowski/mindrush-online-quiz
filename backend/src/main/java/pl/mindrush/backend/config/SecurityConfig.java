...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/app/info").permitAll()

                        .requestMatchers(HttpMethod.POST, "/api/auth/register").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/refresh").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/logout").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/verification/resend").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/lobbies/*/ready").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/lobbies/*/players/*/kick").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/lobbies/*/players/*/ban").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource(AppCorsProperties corsProperties) {
        ...
        config.setAllowedOrigins(corsProperties.normalizedAllowedOrigins());
